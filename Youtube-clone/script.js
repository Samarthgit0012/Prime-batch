...
const getData = () => {
    const pr = fetch("https://youtube138.p.rapidapi.com/v2/trending", {
        method : "GET", // optional : coz GET is default
        headers:{
...
const showUI = (list) => {
    list.forEach((obj, idx) => {
        ...
        newCard.innerHTML = `
            <img src = '${obj.videoThumbnails[0].url}' width="100%" onmouseover='handleHover(event, id = ${idx})'>
            <h6>${obj.author}</h6>
            <h4>${obj.title}</h4>
        `;
